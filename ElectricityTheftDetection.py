...
main = tkinter.Tk()
main.title("Robust Data Driven Analysis for Electricity Theft Attack-Resilient Power Grid") 
...
font = ('times', 16, 'bold')
title = Label(main, text='Robust Data Driven Analysis for Electricity Theft Attack-Resilient Power Grid', justify=LEFT)
